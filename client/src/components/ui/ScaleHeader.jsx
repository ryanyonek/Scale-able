    ...
    return (
        <BrowserRouter>
            <nav className="navbar">
                ...
                <NavLink className={({ isActive }) => isActive ? "navlink active-link hover-item" : "navlink hover-item"} to="/">Scale Viewer</NavLink>
                <NavLink className={({ isActive }) => isActive ? "navlink active-link hover-item" : "navlink hover-item"} to="/transpose">Transpose</NavLink>
                <NavLink className={({ isActive }) => isActive ? "navlink active-link hover-item" : "navlink hover-item"} to="/worksheet-generator">Worksheet Generator</NavLink>
            </nav>
